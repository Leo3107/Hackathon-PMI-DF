    ...
    <div className={cn('flex flex-col gap-4', className)}>
      <Card className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex min-w-0 flex-col gap-1">
          <p className="type-eyebrow text-fg-secondary">
            Analisando{' '}
          ...
          {registro.length === 0 && !corrente ? (
            ...
            <ul className="flex flex-col">
              {registro.map((item) => (
                <li
                  key={item.id}
                  className="flex items-baseline gap-3 border-b border-line-subtle px-4 py-1.5 last:border-b-0"
                >
                  ...
                  <span className="type-caption min-w-0 text-fg-primary">{item.texto}</span>
                </li>
              ))}
              {corrente ? (
                <li
